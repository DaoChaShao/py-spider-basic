...
- **utils:** add decorator module with timing and beautification utilities ([b0b8aca](https://github.com/DaoChaShao/py-spider-basic/commit/b0b8aca214515a2ff06af13de3bd6edbd941664a))
- **utils:** add comprehensive utility module with formatting and helper tools ([8e725c7](https://github.com/DaoChaShao/py-spider-basic/commit/8e725c783b9aea5247a5ed9e577e08ac88ece192))
- **web:** add web request handler with response status management ([0ffc41b](https://github.com/DaoChaShao/py-spider-basic/commit/0ffc41b9d3b732a9182d6c355e9487842e7ab179))
- **http:** add HTTP response status code handling module ([549a505](https://github.com/DaoChaShao/py-spider-basic/commit/549a505aaa56c9dc26012d7c92f5324da3d36203))
...
- **utils:** add .gitignore file for Python project ([d702a1c](https://github.com/DaoChaShao/py-spider-basic/commit/d702a1cb8d1c2772a20513379b5f27401a8bebae))

### Docs

- **readme:** add Chinese README with privacy policy and setup instructions ([a234143](https://github.com/DaoChaShao/py-spider-basic/commit/a234143b09f2d1a701d585c9d655f3f0d263b3b2))
- **readme:** add comprehensive README with privacy notice and setup instructions ([cf8a9e2](https://github.com/DaoChaShao/py-spider-basic/commit/cf8a9e2128051e13fb2f8c4041e02201983a48c0))
- **guide:** add introduction guide for web scraping basics ([2b2cdcf](https://github.com/DaoChaShao/py-spider-basic/commit/2b2cdcf0072fdb63ef7ea266bd5bb9a95b9e376f))
